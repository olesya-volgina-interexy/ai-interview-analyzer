...
Your task: generate ONE Markdown section titled "## Client interview prep" — a focused, personalised cheat-sheet of likely interview questions and how to answer them.
...
### {Question text}
**How to answer:** {specific guidance tied to the candidate's CV and to what this client values}
...
Rules:
1. Output language: English. Question text and guidance — both in English.
...
6. Do NOT add a preamble before "## Client interview prep". The first line of your response MUST be exactly that heading.
...
Generate the "## Client interview prep" section now, following the rules from the system prompt.
`.trim();
}
